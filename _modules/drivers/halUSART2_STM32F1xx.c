...
#define TBUF2_SIZE   (USART2_BUF_TX_SIZE / 2) /*** Must be a power of 2 (2,4,8,16,32,64,128,256,512,...) ***/
#define RBUF2_SIZE   (USART2_BUF_RX_SIZE / 2) /*** Must be a power of 2 (2,4,8,16,32,64,128,256,512,...) ***/
