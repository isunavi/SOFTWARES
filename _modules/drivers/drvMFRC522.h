 ...
 * Extended by Tom Clement with functionality to write to sector 0 of ] changeable Mifare cards.
...
extern "C" {
	...
	void PCD_WriteRegisterM(uint8_t reg, uint8_t count, uint8_t *values);
	uint8_t PCD_ReadRegister(uint8_t reg);
	//void PCD_ReadRegisterM(uint8_t reg, uint8_t count, uint8_t *values, uint8_t rxAlign = 0);
    void PCD_ReadRegisterM(uint8_t reg, uint8_t count, uint8_t *values, uint8_t rxAlign );
