...
typedef enum  {
    SPIFLASH_SIZE_256_MB,
    SPIFLASH_SIZE_128_MB,
    SPIFLASH_SIZE_64_MB,
    SPIFLASH_SIZE_32_MB,
    SPIFLASH_SIZE_16_MB,
    SPIFLASH_SIZE_8_MB,
    ...
    SPIFLASH_SIZE_2_MB,
    SPIFLASH_SIZE_1_MB,
    SPIFLASH_SIZE_512_kB,
    SPIFLASH_SIZE_256_kB,
    SPIFLASH_SIZE_128_kB,
    SPIFLASH_SIZE_64_kB
    
} SPIFLASH_SIZESTypeDef;
...
uint32_t halSPIFLASH_readDeviceId (void);
