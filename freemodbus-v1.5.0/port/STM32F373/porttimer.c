...
xMBPortTimersInit (USHORT usTim1Timerout50us )
{
	...
	timeout = usTim1Timerout50us + 2000; //ZAY - +20ms? тому что не успевал центральный контроллер перевести линию с передачи на прием и наш пакет ответа терялся?
...
void _TIM6_DAC1_IRQHandler (void) {
	/* TIM Update event */
